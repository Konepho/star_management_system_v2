<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Add Student Daily Report</h2>
                <p class="text-sm text-slate-600">Write a simple daily remark for a student.</p>
            </div>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('student-daily-reports.store') }}" class="space-y-6">
                    @csrf
